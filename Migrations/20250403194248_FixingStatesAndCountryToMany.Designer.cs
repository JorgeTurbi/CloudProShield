...
namespace CloudShield.Migrations
{
    ...
    [Migration("20250403194248_FixingStatesAndCountryToMany")]
    partial class FixingStatesAndCountryToMany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CloudShield.Entities.Users.Address", b =>
                {
                    ...
                    b.HasIndex("CountryId1")
                        .IsUnique()
                        .HasFilter("[CountryId1] IS NOT NULL");
            ...
            modelBuilder.Entity("CloudShield.Entities.Users.Address", b =>
                {
                    ...
                    b.HasOne("Entities.Users.Country", null)
                        .WithOne("Address")
                        .HasForeignKey("CloudShield.Entities.Users.Address", "CountryId1");
                    ...
                    b.HasOne("Entities.Users.State", null)
                        .WithOne("Address")
                        .HasForeignKey("CloudShield.Entities.Users.Address", "StateId1");
