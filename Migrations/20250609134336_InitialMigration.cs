    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileResourcesCloud", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileResourcesCloud_SpacesClouds_SpaceId",
                        column: x => x.SpaceId,
                        principalTable: "SpacesClouds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1d14a2a4-9f7e-407d-9f6e-95e7c43a9de9"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Reader", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("8b7ab1a0-5182-4eb3-a2d7-178da4d31e1c"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Delete", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("978b1712-9c5e-48cf-9c4d-6d64d5a88e18"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Update", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("b50eb037-cb39-4f42-bf03-d1738cc21091"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "View", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("c5c6f0da-99e2-4e01-8d84-110985a5e5b2"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Write", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a46e9f62-5373-4aaf-82d4-2b9eb1ad8a2b"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Has limited access to the system, can view and interact with allowed features based on their permissions. Typically focuses on using the core functionality", "User", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("e8f35a92-3eae-447c-9cb2-d3e51c5a97c3"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Has full access to all system features, settings, and user management. Responsible for maintaining and overseeing the platform.", "Administrator", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                table: "SpacesClouds",
                columns: new[] { "Id", "CreateAt", "MaxBytes", "UpdateAt", "UsedBytes", "UserId" },
                values: new object[] { new Guid("c36f258b-9ad3-4640-9a9b-ff9701dc9f8e"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1073741824L, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0L, new Guid("d3f9d6c9-b4f5-4e5b-a6f1-cab3fbe287a7") });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileResourcesCloud_SpaceId_RelativePath",
                table: "FileResourcesCloud",
                columns: new[] { "SpaceId", "RelativePath" },
                unique: true);
